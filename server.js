...
const cfg = {port: Number(env.PORT || process.env.PORT || 3000), appUrl: env.APP_URL || process.env.APP_URL || 'http://localhost:3000', resendKey: env.RESEND_API_KEY || process.env.RESEND_API_KEY, from: env.MAIL_FROM || process.env.MAIL_FROM, adminEmail:'admin@cyberquest.demo', adminPassword:'CyberQuest2026!'};
